...
const ImageSequenceAnimation = ({
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full h-[calc(100dvh)] overflow-hidden "
    >
      <div
        ref={backgroundRef}
      ...
      <canvas
        ref={canvasRef}
        className={`absolute inset-0 w-full h-full pt-16 object-contain ${
          vertical ? "object-cover object-top" : "md:object-cover md:object-top"
        }`}
      />
